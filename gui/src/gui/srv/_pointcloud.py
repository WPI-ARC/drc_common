"""autogenerated by genpy from gui/pointcloudRequest.msg. Do not edit."""
import sys
...
class pointcloudRequest(genpy.Message):
  _md5sum = "5c0259bdcc35727606f0ca3c6eb773fe"
  _type = "gui/pointcloudRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool voxel
float32 x
float32 y
float32 z

"""
  __slots__ = ['voxel','x','y','z']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3f.pack(_x.voxel, _x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.voxel, _x.x, _x.y, _x.z,) = _struct_B3f.unpack(str[start:end])
      self.voxel = bool(self.voxel)
      return self
...
"""autogenerated by genpy from gui/pointcloudResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class pointcloud(object):
  _type          = 'gui/pointcloud'
  _md5sum = '45789167c8b5348e32273faa0d04173c'
